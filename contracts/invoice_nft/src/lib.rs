...
pub enum DataKey {
    ...
    UpgradeProposal,
    /// Instance key: optional risk_registry contract address for credit-limit checks
    RiskRegistry,
    /// Persistent key: tracks aggregate outstanding face value per SME (non-Repaid/Defaulted)
...
impl InvoiceNftContract {
    ...
    pub fn mint_invoice(
        ...
        // Track outstanding exposure for credit-limit enforcement
        ...
        env.storage().persistent().set(
            ...
            &prev_exposure.checked_add(amount).ok_or(KoraError::ArithmeticOverflow)?,
        );
