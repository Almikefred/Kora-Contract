...
use kora_shared::{
    ...
    validation::{bps_of_normalized, require_non_zero_amount, require_valid_fee_bps, require_within_max_amount, safe_add, safe_div, safe_mul, safe_sub, UPGRADE_TIMELOCK_DELAY},
};
...
impl MarketplaceContract {
    ...
    fn fund_invoice_internal(
        ...
        events::invoice_funded(env, invoice_id, investor, listing_amount);
        if fee > 0 {
